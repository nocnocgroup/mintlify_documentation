...
Test your key with a simple products request:
...
```javascript
const res = await fetch('https://live.nocnocstore.com/api/v2/products', {
...
A `200` response means you're authenticated and ready to go. A `401` means your key is missing or incorrect.
