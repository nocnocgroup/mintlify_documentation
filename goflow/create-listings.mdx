---
title: "Creating nocnoc listings"
description: "How to create nocnoc listings in GoFlow using Amazon ASINs."
---

nocnoc listings in GoFlow are created using Amazon ASINs. GoFlow looks up the listing details on Amazon and uses them to build your nocnoc catalog automatically — you only need to provide minimal data.
