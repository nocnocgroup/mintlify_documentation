...
<Steps>
  <Step title="Create a new store">
    ...
    <img src="/goflow/images/image2.png" alt="Create new store" style={{marginBottom: "16px"}} />
  ...
  <Step title="Connect the store to nocnoc">
    ...
    <img src="/goflow/images/image3.png" alt="Enter API key" style={{marginBottom: "16px"}} />
  ...
  <Step title="Configure the store settings">
    ...
    **Inventory** — In the **Inventory Allocation** card, click **Add Inventory Allocation Settings** to configure inventory allocation.
    ...
    <img src="/goflow/images/image1.png" alt="Inventory Allocation settings" />
