...
<CardGroup cols={2}>
  <Card title="Option 1 — Order Printer Pro" icon="print" href="/shopify/packing-slip#order-printer-pro">
    Requires the [Order Printer Pro](https://apps.shopify.com/order-printer-pro) app from the Shopify App Store.
  </Card>
  <Card title="Option 2 — Native packing slips" icon="file" href="/shopify/packing-slip#native-packing-slips">
