...
<Note>
  We recommend using **Option 1 (Order Printer Pro)** whenever possible. It's easier to set up and provides a more reliable barcode rendering.
</Note>

<CardGroup cols={2}>
  <Card title="Option 1 — Order Printer Pro plugin" icon="printer" href="#option-1--order-printer-pro-plugin">
    If you use the Order Printer Pro plugin to generate labels.
  </Card>
  <Card title="Option 2 — Native packing slips" icon="file" href="#option-2--native-packing-slips">
...
## Option 1 — Order Printer Pro plugin
