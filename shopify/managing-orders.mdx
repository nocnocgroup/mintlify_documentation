...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginTop: '8px' }}>
  <div style={{ border: '1px solid #e5e7eb', borderRadius: '10px', padding: '20px' }}>
    <img src="https://cdn.jsdelivr.net/npm/@tabler/icons/icons/user.svg" style={{ width: '18px', height: '18px', marginBottom: '12px', opacity: 0.4, pointerEvents: 'none' }} alt="" />
  ...
  <div style={{ border: '1px solid #e5e7eb', borderRadius: '10px', padding: '20px' }}>
    <img src="https://cdn.jsdelivr.net/npm/@tabler/icons/icons/tag.svg" style={{ width: '18px', height: '18px', marginBottom: '12px', opacity: 0.4, pointerEvents: 'none' }} alt="" />
  ...
  <div style={{ border: '1px solid #e5e7eb', borderRadius: '10px', padding: '20px' }}>
    <img src="https://cdn.jsdelivr.net/npm/@tabler/icons/icons/map-pin.svg" style={{ width: '18px', height: '18px', marginBottom: '12px', opacity: 0.4, pointerEvents: 'none' }} alt="" />
